...
export default class ContactsEditPart extends BaseComponent {
    ...
    getFullName() {
        ...
        const { surname, name, patronymic } = this._name;
    ...
    renderDOM() {
        ...
        el.append(surnameEl, nameEl, patronymicEl, phoneEl, buttonCloseEl);
        return el
    }
    ...
    save() {
        ...
        if (!surnameData || !nameData || !patronymicData || !nameData || !phoneData) {
            return null;
        }
